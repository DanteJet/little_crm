...
- **Расписание**:
  ...
  - сохранение времени как московского wall time (`Europe/Moscow`);
...
- **В расписании время отображается не так, как введено** — приложение хранит дату в UTC, но формы и вывод работают в часовом поясе `Europe/Moscow`.
